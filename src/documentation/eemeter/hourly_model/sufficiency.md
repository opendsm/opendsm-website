...
##### **2.1.3.1 Predicted Energy Aggregation**
<div style="padding-left: 20px;" markdown="1">
Predicted energy can be aggregated through simple summation
</div>

##### **2.1.3.2 Predicted Energy Uncertainty Aggregation**
<div style="padding-left: 20px;" markdown="1">
...
#### **2.1.5 Location**
<div style="padding-left: 20px;" markdown="1">
There are two options for location data, but [Daily DQ 2.1.5.1](#2151-latitude-and-longitude) is greatly preferred.

##### **2.1.5.1 Latitude and Longitude**
<div style="padding-left: 20px;" markdown="1">
Latitude and longitude should be known to three decimal places
</div>

##### **2.1.5.2 ZIP Code Tabulation Area (ZCTA)**
<div style="padding-left: 20px;" markdown="1">
...
#### **2.2.3: Datetime Time Zone-Aware**
<div style="padding-left: 20px;" markdown="1">
...
#### **2.2.10: Solar Model Sufficiency**
<div style="padding-left: 20px;" markdown="1">

##### **2.2.10.1: Minimum Daily GHI Coverage**
<div style="padding-left: 20px;" markdown="1">
The percentage of valid days (days with greater than 90% valid GHI data coverage) must be greater than 90%
</div>

##### **2.2.10.2: Minimum Monthly GHI Coverage**
<div style="padding-left: 20px;" markdown="1">
Each month in the period must have at least 90% valid GHI data for all datetimes
</div>
...
##### **2.3.1.1: Maximum Baseline Length**
<div style="padding-left: 20px;" markdown="1">
The baseline length must be less than 366 days. This is 1 day longer than a standard year to account for leap years
</div>

##### **2.3.1.2: Minimum Baseline Length**
<div style="padding-left: 20px;" markdown="1">
The baseline length must be at least the floor of 90% of the maximum baseline length as defined in [Daily DQ 2.3.1.1](#2311-maximum-baseline-length), floor(366*0.9) = 329 days
</div>

##### **2.3.1.3: Full Datetime Range**
<div style="padding-left: 20px;" markdown="1">
...
#### **2.3.2: Negative Gas Data**
<div style="padding-left: 20px;" markdown="1">
For gas data, observed values may not be less than 0
</div>

#### **2.3.3: Minimum Daily Observed Coverage**
<div style="padding-left: 20px;" markdown="1">
The percentage of valid days (days with greater than 90% valid observed data coverage) must be greater than 90%
</div>

#### **2.3.4: Minimum Monthly Observed Coverage**
<div style="padding-left: 20px;" markdown="1">
Each month in the period must have at least 90% valid observed data for all datetimes
</div>
...
## **Model Sufficiency**
A fit hourly model must meet either [CVRMSE](site:documentation/general_concepts/#cvrmse) <span style="color: orange;">or</span> [PNRMSE](site:documentation/general_concepts/#pnrmse) criteria to be qualified for measurement.
...
<div style="padding-left: 20px;" markdown="1">
The adjusted CVRMSE must be less than or equal to 1.4
</div>
...
<div style="padding-left: 20px;" markdown="1">
The adjusted PNRMSE must be less than or equal to 2.2
</div>
