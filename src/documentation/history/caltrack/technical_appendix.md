...
## <span id="appendix2-2-1-2"></span>[2.2.1.2.](methodology.md#methods2-2-1-2) For fitting baseline models using the hourly methods, no minimum baseline period length is required.
...
## <span id="appendix2-2-4-1"></span>[2.2.4.1.](methodology.md#methods2-2-4-1) Temperature data may not be missing for more than six consecutive hours.

The decision to linearly interpolate up to 6 consecutive missing hours of weather data is adapted from Mathieu et al's [Quantifying Changes in Building Electricity Use, with Application to Demand Response (Section 2.2)](http://eta-publications.lbl.gov/sites/default/files/LBNL-4944E.pdf#page=5).

---

## <span id="appendix2-4-1"></span>[2.4.1.](methodology.md#methods2-4-1) Weather station to be used is closest within climate zone that meets CalTrack data sufficiency requirements.
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/2_4_1_image1.png" alt="Model error vs. temperature difference from nearest weather station" style="max-width: 85%;">
  <figcaption><em>Figure: Model error vs. temperature difference from nearest weather station</em></figcaption>
</figure>
...
## <span id="appendix3-1-3"></span>[3.1.3.](methodology.md#methods3-1-3) Models are fit to baseline data in the 365 days immediately prior to the intervention start date.
...
CalTRACK methods adopt the Uniform Methods Project's (UMP) minimum baseline period of 365 days (see UMP guidelines in [6.4.1 Analysis Data Preparation](https://www1.eere.energy.gov/wip/pdfs/53827-8.pdf#page=31)). The obvious justification for a 365 day baseline is the value of fitting a model over a wide range of possible temperatures. Hourly methods may require a different baseline length assumption. The UMP does not provide guidance for the maximum length of the baseline period, so empirical testing was conducted to determine the optimal maximum baseline period length.
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_1_3_image1.png" alt="Effect of baseline period length on normalized annual consumption using daily data" style="max-width: 85%;">
  <figcaption><em>Figure: Effect of baseline period length on normalized annual consumption using daily data</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_1_3_image2.png" alt="Effect of baseline period length on model R-squared distribution" style="max-width: 85%;">
  <figcaption><em>Figure: Effect of baseline period length on model R-squared distribution</em></figcaption>
</figure>
...
## <span id="appendix3-1-4-1"></span>[3.1.4.1.](methodology.md#methods3-1-4-1) Select and qualify balance points for candidate models for each period for each meter.
...
<figure markdown style="text-align: center;">
  ...
  <figcaption><em>Figure: R-squared for fixed and variable balance points</em></figcaption>
</figure>
...
## <span id="appendix3-2-1"></span>[3.2.1.](methodology.md#methods3-2-1) A grid search of models is performed using a wide range of candidate balance points.
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_2_1_image1.png" alt="HDD balance point frequency by grid search range" style="max-width: 85%;">
  <figcaption><em>Figure: HDD balance point frequency by grid search range</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_2_1_image2.png" alt="Estimated savings with different grid search ranges" style="max-width: 85%;">
  <figcaption><em>Figure: Estimated savings with different grid search ranges</em></figcaption>
</figure>
...
## <span id="appendix3-2-3"></span>[3.2.3.](methodology.md#methods3-2-3) Maximum gap between candidate balance points in the grid search is 3 degrees F or the equivalent in degrees C.
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_2_3_image1.png" alt="HDD balance points with different search increments" style="max-width: 85%;">
  <figcaption><em>Figure: HDD balance points with different search increments</em></figcaption>
</figure>
...
## <span id="appendix3-3-1-2"></span>[3.3.1.2.](methodology.md#methods3-3-1-2) Independent variables
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_3_1_2_image1.png" alt="Average residuals vs. temperature" style="max-width: 85%;">
  <figcaption><em>Figure: Average residuals vs. temperature</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_3_1_2_image2.png" alt="Average residuals vs. day-of-month" style="max-width: 85%;">
  <figcaption><em>Figure: Average residuals vs. day-of-month</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_3_1_2_image3.png" alt="Average residuals vs. month-of-year" style="max-width: 85%;">
  <figcaption><em>Figure: Average residuals vs. month-of-year</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_3_1_2_image4.png" alt="Average residuals vs. day-of-week" style="max-width: 85%;">
  <figcaption><em>Figure: Average residuals vs. day-of-week</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_3_1_2_image5.png" alt="CVRMSE vs. NMBE" style="max-width: 85%;">
  <figcaption><em>Figure: CVRMSE vs. NMBE</em></figcaption>
</figure>
...
## <span id="appendix3-4-1"></span>[3.4.1.](methodology.md#methods3-4-1) Models using daily data are fit using ordinary least squares.
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_1_image1.png" alt="Distribution of NMBE for robust regression and ordinary least squares" style="max-width: 85%;">
  <figcaption><em>Figure: Distribution of NMBE for robust regression and ordinary least squares</em></figcaption>
</figure>
...
## <span id="appendix3-4-3-2"></span>[3.4.3.2.](methodology.md#methods3-4-3-2) Candidate model qualification.
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_3_2_image1.png" alt="Best-fit model with p-value screen" style="max-width: 85%;">
  <figcaption><em>Figure: Best-fit model with p-value screen</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_3_2_image2.png" alt="Mean absolute error with and without p-value screen" style="max-width: 85%;">
  <figcaption><em>Figure: Mean absolute error with and without p-value screen</em></figcaption>
</figure>
...
## <span id="appendix3-4-3-3"></span>[3.4.3.3.](methodology.md#methods3-4-3-3) The model with highest adjusted R-squared will be selected as the final model.
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_3_3_image1.png" alt="Loss function distributions" style="max-width: 85%;">
  <figcaption><em>Figure: Loss function distributions</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_3_3_image2.png" alt="Frequency of balance point temperatures by loss function" style="max-width: 85%;">
  <figcaption><em>Figure: Frequency of balance point temperatures by loss function</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_3_3_image3.png" alt="Balance point standard deviation by loss function" style="max-width: 85%;">
  <figcaption><em>Figure: Balance point standard deviation by loss function</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_3_3_image4.png" alt="Balance point standard deviation by loss function (edges removed)" style="max-width: 85%;">
  <figcaption><em>Figure: Balance point standard deviation by loss function (edges removed)</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_4_3_3_image5.png" alt="Quadratic loss function balance point standard deviations" style="max-width: 85%;">
  <figcaption><em>Figure: Quadratic loss function balance point standard deviations</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_6_5_image1.png" alt="Annual vs. monthly regressions" style="max-width: 85%;">
  <figcaption><em>Figure: Annual vs. monthly regressions</em></figcaption>
</figure>
...
<figure markdown style="text-align: center;">
  <img src="site:assets/images/history/caltrack/3_6_5_image2.png" alt="In- and out-of-sample CVRMSE" style="max-width: 85%;">
  <figcaption><em>Figure: In- and out-of-sample CVRMSE</em></figcaption>
</figure>
...
<style>
/* Limit TOC depth to show only h2 headings on this page */
